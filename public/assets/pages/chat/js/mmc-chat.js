...
var box_minimized_dropdownLi = '<li data-id="{0}"><div class="prenom">{1}</div> <div class="remove">X</div></li>'
...
$(document).on('click', '#main-chat #sidebar .user-box .userlist-box', function () {
    ...
    var dataUserName = $(this).attr('data-prenom');
    var _return = false;
...
$(document).on('click', '#main-chat .boxs .minimized .chat-dropdown .prenom', function (e) {
