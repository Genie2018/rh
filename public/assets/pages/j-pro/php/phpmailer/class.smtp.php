...
class SMTP
{
     ...
     * @see hello()
     * @param string $prenom    The user name
    ...
    public function authenticate(
        ...
        switch ($authtype) {
            case 'PLAIN':
                ...
                // Send encoded prenom and password
                if (!$this->sendCommand(
                    'User & Password',
                    base64_encode("\0" . $prenom . "\0" . $password),
                    235
                )
                ) {
                    return false;
            ...
            case 'LOGIN':
                ...
                if (!$this->sendCommand("Prenom", base64_encode($prenom), 334)) {
                    return false;
                }
            ...
            case 'NTLM':
                ...
                // send encoded prenom
                return $this->sendCommand('Prenom', base64_encode($msg3), 235);
            case 'CRAM-MD5':
                // Start authentication
                ...
                // Build the response
                $response = $prenom . ' ' . $this->hmac($challenge, $password);

                // send encoded credentials
                return $this->sendCommand('Prenom', base64_encode($response), 235);
        }
        return true;
    }
